...
\section{Les données initiales}
	...
	\subsection{L'emploi du temps}
		...
		\begin{enumerate}
			...
			\centerline{\includegraphics[scale=0.5]{exemple1.png}}
			...
			\centerline{\includegraphics[scale=0.5]{exemple2.png}}
			...
			\centerline{\includegraphics[scale=0.5]{exemple3.png}}
			...
			\centerline{\includegraphics[scale=0.5]{exemple4.png}}
		\end{enumerate}
...
\section{Calcul de congestion}
	...
	\begin{tabular}{ | c | c | c | c | c | c |}
 			\hline			
   			...
   			Nombre de personnes dans le bus & 56 & 53 & 60 & 56 & 57 & 57\\
 			\hline  
 	\end{tabular}
...
\section{Stratégie d'optimisation}
	\subsection{Mise en rapport de la congestion et des sommets}
		Il faut dans un premier temps déterminer quels sommets sont les plus impactant en terme de congestion. Une manière pertinente de classer les sommets serait de calculer pour chacun le nombre de nouveaux étudiants qu'ils fais venir à l'université. C'est à dire son nombre d'étudiants moins les étudiants 	
\end{document}
