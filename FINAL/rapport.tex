...
\section{Présentation et analyse des résultats}
	...
	\begin{tabular}{|c|c|c|c|c|}
  		...
  		\hline
	\end{tabular}
	Pour un degré moyen de 10, on constate que les différents algorithmes utilisés on pu améliorer la congestion d'au moins 30\% chacun. On constate également que 
	...
	\subsection{Exemple d'utilisation}
		...
		\subsubsection{Calcul de la congestion}
			...
			\begin{tabular}{ | c | c | c | c | c | c | c |}
 			...
 			Les résultats sont égalements dans les fichiers .
